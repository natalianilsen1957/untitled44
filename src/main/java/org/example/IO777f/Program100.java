...
public class Program100 {
    public static void main(String[] args) {
        ...
        LinkedHashMap<Enum, Map<Integer, List<Student>>> result = students.stream()
                .sorted(Comparator
 ...
 result.forEach((s, map1) -> {   
     System.out.println(s);
     map1.forEach((year,list)-> System.out.printf("%d : %s\n", year, list.stream().map(Student::getName).sorted().collect(Collectors
             .joining(", "))));
     System.out.println();
 });
    }}